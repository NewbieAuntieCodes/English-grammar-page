...
export const presentContinuousStories: PresentContinuousStory[] = [
    {
        ...
        storyData: [
            { prompt: "The sun is shining and we are at the park. A dog...", choices: [{ text: "runs.", isCorrect: false }, { text: "is running.", isCorrect: true }] },
            { prompt: "Some children...", choices: [{ text: "play on the swings.", isCorrect: false }, { text: "are playing on the swings.", isCorrect: true }] },
            ...
            { prompt: "And I...", choices: [{ text: "eat an ice cream.", isCorrect: false }, { text: "am eating an ice cream.", isCorrect: true }] },
    ...
    },
    {
        ...
        storyData: [
            ...
            { prompt: "My brother...", choices: [{ text: "sets the table.", isCorrect: false }, { text: "is setting the table.", isCorrect: true }] },
            { prompt: "My little sister...", choices: [{ text: "watch everyone.", isCorrect: false }, { text: "is watching everyone.", isCorrect: true }] },
    ...
    },
    {
        ...
        storyData: [
            ...
            { prompt: "A man...", choices: [{ text: "sell hot dogs.", isCorrect: false }, { text: "is selling hot dogs.", isCorrect: true }] },
            { prompt: "Some birds...", choices: [{ text: "is flying in the sky.", isCorrect: false }, { text: "are flying in the sky.", isCorrect: true }] },
    ...
    },
    {
        ...
        storyData: [
            { prompt: "It is raining outside, so we...", choices: [{ text: "stay indoors.", isCorrect: false }, { text: "are staying indoors.", isCorrect: true }] },
            { prompt: "My brother...", choices: [{ text: "builds a Lego castle.", isCorrect: false }, { text: "is building a Lego castle.", isCorrect: true }] },
            ...
            { prompt: "We...", choices: [{ text: "feel very cozy.", isCorrect: false }, { text: "are feeling very cozy.", isCorrect: true }] },
    ...
    },
    {
        ...
        storyData: [
            { prompt: "Look! Everyone is at the party. Music...", choices: [{ text: "plays loudly.", isCorrect: false }, { text: "is playing loudly.", isCorrect: true }] },
            ...
            { prompt: "The birthday girl...", choices: [{ text: "opens her presents.", isCorrect: false }, { text: "is opening her presents.", isCorrect: true }] },
            { prompt: "Everyone...", choices: [{ text: "has a lot of fun.", isCorrect: false }, { text: "is having a lot of fun.", isCorrect: true }] },
