...
export const cardDataConfig = [
    ...
    { id: 'pos-components-bridge', title: '词性 vs 句子成分', subtitle: 'How They Connect', color: '#20b486' },
    { id: 'structures', title: '基础句型结构', subtitle: 'Basic Sentence Structures', color: '#ff6b6b' },
    { id: 'questions', title: '疑问句学习', subtitle: 'Questions', color: '#ff4757' },
    ...
    { id: 'pronunciation', title: '发音练习', subtitle: 'Pronunciation Practice', color: '#9b59b6' },
];
